...
<body class="font-sans bg-[#181A20] text-white">
    ...
    <div class="container mx-auto px-6 scroll-container">
        <!-- Jumbotron -->
        <div class="scroll-section p-8 flex flex-col md:flex-row items-center space-y-6 md:space-y-0 md:space-x-6 h-screen">
            <div class="md:w-1/2">
        ...
        <div class="scroll-section mt-12 flex flex-col md:flex-row items-center justify-between text-center md:text-left h-screen">
            <!-- Wallet Section -->
            ...
            <div class="md:w-1/2 px-6 mt-6 md:mt-0">
                ...
                <p class="mt-4 text-gray-400">
                    Whether you want to save for a big purchase, or just want to keep track of your spending, we've got you covered. Create wallets tailored to your financial goals.
                </p>
                <a href="/wallets" class="mt-6 inline-block bg-[#FCD535] text-gray-900 px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-yellow-500 transition">
                    Start Customizing
                </a>
            </div>
        </div>
        ...
        <div class="scroll-section mt-12 flex flex-col md:flex-row items-center justify-between text-center md:text-left h-screen">
            ...
            <div class="md:w-1/2 px-6">
                ...
                <p class="mt-4 text-gray-400">
                    Gain insights into your financial health. Compare your income and expenses easily, and make smarter decisions to achieve your financial goals.
                </p>
                <a href="/dashboard" class="mt-6 inline-block bg-[#FCD535] text-gray-900 px-6 py-3 rounded-lg font-semibold shadow-lg hover:bg-yellow-500 transition">
                    Learn More
                </a>
            </div>
